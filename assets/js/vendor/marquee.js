    ...
    $.fn.marquee = function(options) {
        return this.each(function() {
                    ...
                    resume: function() {
                        ...
                        if (css3AnimationIsSupported && o.allowCss3Support) {
                            ...
                            if ($.fn.resume) {
                                ...
                                $('body').removeClass('marquee-hover');
                            }
                        }
                        // save the status
            ...
            var animate = function() {
				...
				//console.log(JSON.stringify(animationCss));
                //console.log((elWidth));
				$this.attr('data-width',elWidth);
                // fire event
                ...
                if (css3AnimationIsSupported) {
                    ...
                    $marqueeWrapper.animate(animationCss, {
	                    ...
	                    step: function(now, fx){
	                    	$marqueeWrapper.attr('data-margin',now);
						}, complete: function() {
	                        // fire event
	                        $this.trigger('finished');
	                        // animate again
